    ...
    pages: [
      Page(
        sections: [
          ...
          Paragraph(
            text: 'Diagram 1-1 is from a Yagura opening where White has just exchanged Pawns on 5e.',
          ),
          Paragraph(
            text:
          ...
          Paragraph(
            text:
                "In Diagram 1-2, White has just played B7c, giving priority to defense. The Bishop here is for restricting Black's offensive formation.",
          ),
          Paragraph(
            text:
                "On the other hand, the Bishop pulled to 4b (Diagram 2-1) is for applying pressure on Black's King, therefore an offensive move.",
          ),
          Diagram(
      ...
      Page(
        sections: [
          ...
          Paragraph(
            text:
                'Diagram 2-2 (last move K-6h) shows where White has just opened the way for the opening called Masuda-style Ishida-ryu opening.',
          ),
          Diagram(
          ...
          Paragraph(
            text:
                "From Diagram 2-2, White can play P-3f. Then there will be a Bishop-exchange followed by White's B*5e (Diagram 2-2). You may think White has gained the lead.",
          ),
          Diagram(
    ...
    pages: [
      Page(
        sections: [
          ...
          Paragraph(
            text:
                'Diagram 1-1 shows White, who has already forfeited a Knight, has just dropped a Bishop on 8h. A daring move. Kx8h would only invite White to play Rx6i+, which would be too devastating for Black. When left unattended, White will play Bx9i+, promoting the Bishop on a very good square on top of taking a Lance.',
          ),
          MoveSequence(
          ...
          Paragraph(
            text:
                'B*5e in Diagram 1-2 can be a dangerous move. If you play either S8h or N7g, it will only allow White to play Bx8h or Bx7g so that he can next play Rx6i+.',
          ),
          Paragraph(
      ...
      Page(
        sections: [
          ...
          Paragraph(
            text:
                "Diagram 2-1 shows where White, in an attempt to cope with Black's bo-gin (climbing Silver), has just dropped a Bishop on 5d. If P2d, Px2d, Sx2d as Black intends to play, White can then drop a Pawn on 2g blocking the Rook's path.",
          ),
          Paragraph(
            text: 'So, the move Black should play in Diagram 2-1 is...?',
          ),
          MoveSequence(
            moves: [
              'B*3h',
          ...
          Paragraph(
            text:
                'Look at Diagram 2-2. White has no Pawn in hand, which means it will not be easy for White to defend the second file. Having "Bishop for Bishop" well applied, Black has a very good position here.',
          ),
        ],
      ),
    ],
