    ...
    pages: [
      Page(
        sections: [
          ...
          Paragraph(
            text:
                "Diagram 1-1 shows where White has just dropped a Rook on 2i. If Black plays likewise: R*4a, White will then play P*2b blocking the path of Black's Horse.",
          ),
          Diagram(
          ...
          Paragraph(
            text:
                "If the Dragon instead of the Horse was in White's camp as in Diagram 1-3, Black can play +R2i after P*2b. In this way Black can place the Dragon on a vital point in just one move. But in Diagram 1-2, Black has to play two moves, i.e.,+B1b and +Bx3d, before the Horse comes to a good square.",
          ),
          Paragraph(
          ...
          Paragraph(
            text:
                'Back in Diagram 1-1, the move you should play is +B6f (Diagram 1-4). See for yourself that the Horse is on a very good square both in offense and defense.',
          ),
          Diagram(
          ...
          MoveSequence(
            description: 'Moves after Diagram 1-4:',
            moves: [
              'Rx1i+',
              'P9e',
              'Px9e',
          ...
          Paragraph(
            text:
                'After Diagram 1-5, if White plays Lx9c, you can go on to play P*9d. White will respond with Lx9d, then you can play N*8f, claiming a Lance on 9d and a Pawn on 7d at the same time. This is a quite favorable position for you.',
          ),
          Paragraph(
      ...
      Page(
        sections: [
          Paragraph(
            text:
                'The following position (Diagram 2-1) is from a professional title match. The move which can be called the quintessence of the proverb above actually decided the game.',
          ),
          Diagram(
          ...
          Paragraph(
            text:
                "The game began with the Hineri-bisha opening which led to a wild middlegame, with both players vying to set their own Rooks free from their entangled positions (sabaku). Diagram 2-1 shows where White has just played N4g+, closing in on Black's camp. Since the King's guard is rather thin, White's S*5i or +N5h could be quite devastating.",
          ),
          MoveSequence(
            moves: [
              '+B7g',
          ...
          MoveSequence(
            description: 'Moves after Diagram 2-3:',
            moves: [
              'Sx6g=',
              '+Bx6g',
              '+N5h',
