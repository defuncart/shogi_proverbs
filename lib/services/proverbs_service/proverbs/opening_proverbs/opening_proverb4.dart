  ...
  pages: [
    Page(
      sections: [
        ...
        Paragraph(
          text: 'If you play P9f in Diagram 1-1, there will follow:',
        ),
        MoveSequence(
          moves: [
            'P9f',
        ...
        Paragraph(
          text:
              'From Diagram 1-3, White can play R9b or P*9g, while Black is far from being comfortable having a skirmish started quite close to his King.',
        ),
      ],
    ),
    Page(
      sections: [
        Paragraph(
          text: "What if you don't play P9f in Diagram 1-1?",
        ),
        MoveSequence(
          moves: [
            'P4f',
        ...
        Paragraph(
          text:
              "By not playing P9f in response to P9d, you have managed to keep White's attacking pieces at bay. You have allowed him to advance his edge Pawn to 9e instead, but Diagram 1-2 shows that you are the one to go first.",
        ),
        Paragraph(
          text: 'Again back in Diagram 1-1, what if White resorts to the Bo-gin?',
        ),
        MoveSequence(
          moves: [
            'P4f',
        ...
        Paragraph(
          text:
              "Lastly, let me add the position in which you can play the edge Pawn. If White's Knight is on 7c at an early stage, as in Diagram 2-3, you can safely play P9f. In other words, as long as it's certain that White does not employ the Bo-gin, you can play P9f after White's P9d.",
        ),
        Diagram(
